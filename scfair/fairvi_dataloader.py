...
from .fairvi_dataset import FairAnnTorchDataset


class FairVIDataLoader(DataLoader):
    ...
    def __init__(
        ...
        **data_loader_kwargs,
        ...
        # this is the only difference from the original DataLoader at scvi-tools:
        ###############################################
        self.dataset = FairAnnTorchDataset(adata_manager, getitem_tensors=data_and_attributes)
